...
RSpec.describe User, type: :model do
  ...
  it 'Expects to be invalid if email is not present' do
    @user1.email = nil
    @user1.save
    expect(@user1.errors.full_messages).to eq(["Email can't be blank",
  ...
  it 'Expects to be invalid if name is not present' do
    @user1.name = nil
    @user1.save
    expect(@user1.errors.full_messages).to eq(["Name can't be blank",
  ...
  it 'Expects to be invalid if password is not present' do
    @user1.password = nil
    @user1.save
    expect(@user1.errors.full_messages).to eq(["Password can't be blank",
  ...
  it 'Expects to be invalid if user_type is not present' do
    @user1.user_type = nil
    @user1.save
    expect(@user1.errors.full_messages).to eq(["User type can't be blank",
